...
<form enctype="multipart/form-data"      class="formulario-de-inclusao"   role="form" method="GET"  action="{{route('redirecionaAtendimento.index')}}">
...
<input id="pacienteN" type="hidden" disabled class="form-control" name="pacienteN" value ="{{$name}}" >
                    ...
                    <div class="col-md-5">
                     ...
                     <div class="col-md-4">
                 	<h5 style="margin-top:0px;">Primeira Consulta em :<b>0{{$criado_em}}</b></h5>
...
" role="document">
    <div class="modal-content">
      ...
      <div class="caption">
        ...
        <p class="p-cartao"><a href="#" class="btn btn-primary botao-card" name="botao-anamnese" role="submit">Selecionar</a> <!--{{route('anamnese.index')}}-->
      </div>
     </div>
     </div>
